...
<%@page import="eTicaret.admin.Kullanici"%>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item"><a class="nav-link"
							href="/eTicaret/admin/products">Ürünler</a></li>
						<li class="nav-item"><a class="nav-link"
							href="/eTicaret/admin/categories">Kategoriler</a></li>
						<li class="nav-item"><a class="nav-link"
							href="/eTicaret/admin/users">Kullanıcılar</a></li>
					</ul>
