...
<body class="admin-body">
	...
	<div class="container pt-4">
		...
		<div class="row mb-4">
			<div class="col">
				<a class="btn btn-secondary" href="/eTicaret/admin/dashboard">Geri</a>
						...
						<div class="col">
				<form action="/eTicaret/admin/category/search" method="get">
			...
			<div class="col text-end">
				<a class="btn btn-primary" href="/eTicaret/admin/category/add">Kategori
					Ekle</a>
			</div>
		</div>
		...
		<table class="table">
			...
			<tbody>
				<%
				Object obj = request.getAttribute("kategoriler");
				if (obj instanceof ArrayList<?>) {
					List<?> objeler = (List<?>) obj;

					for (Object obje : objeler) {
						if (obje instanceof Kategori) {
					Kategori kategori = (Kategori) obje;
				%>
				<tr>
					<th scope="row" class="align-middle"><%=kategori.getId()%></th>
					<td class="align-middle"><%=kategori.getAd()%></td>
					<td class="text-end">
						<form action="/eTicaret/admin/category/update" method="get"
							class="d-inline">
